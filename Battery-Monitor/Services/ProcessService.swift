...
class ProcessService: ObservableObject {
    @Published var info: ProcessesInfo?
    @Published var processes: [ProcessesInfo] = []
...
//            process.waitUntilExit()
    ...
    private static func parseLine(_ line: String) -> ProcessesInfo? {
    ...
    private static func fetchProcessesRaw() -> [ProcessesInfo] {
...
struct ProcessesInfo: Identifiable {
    var id: Int { pid }
    var pid: Int
    var command: String
    var state: String
