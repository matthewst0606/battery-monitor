    ...
    var body: some View {
        VStack(spacing: 5) {
            List {
                ListItem(
                    arg1: "Total Memory",
                    arg2: String(format: "%.2fGB", modelRunner.usedMemory),
                    arg3: .primary
                )
                ListItem(
                    arg1: "Used Memory",
        ...
        VStack(spacing: 5) {
            List {
                if let memory = mem.info {
                    ...
                    ListItem(
                        arg1: "Total",
                        arg2: String(format: "%.2f GB", memory.total),
                        arg3: .primary
                    )
                    ...
                    ListItem(
                        arg1: "Available",
                        arg2: String(format: "%.2f GB", memory.available),
                        arg3: .primary
                    )
                    ListItem(
                        arg1: "Cached",
                        arg2: String(format: "%.2f GB", memory.cached),
                        arg3: .primary
                    )
                }
            }.unscrollableListStyle()
