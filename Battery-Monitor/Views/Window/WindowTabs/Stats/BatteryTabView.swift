        ...
        VStack(spacing: 5) {
            List {
                if let battInfo = battery.info {
                    ...
                    case 1000...2000: ListItem(arg1: "Time Remaining", arg2: "\(battery.timeRemainingText)", arg3: .green)
                    case 500...1000:  ListItem(arg1: "Time Remaining", arg2: "\(battery.timeRemainingText)", arg3: .yellow)
                    case 300...500:   ListItem(arg1: "Time Remaining", arg2: "\(battery.timeRemainingText)", arg3: .orange)
                    case 0...300:
                        if battery.timeRemainingText == "0:00" && battInfo.powerSourceState == "AC Power"
                            { ListItem(arg1: "Time Remaining", arg2: "Fully Charged", arg3: .green) }
                        else
                            { ListItem(arg1: "Time Remaining", arg2: "\(battery.timeRemainingText)", arg3: .red) }
